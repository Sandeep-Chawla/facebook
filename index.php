    ...
    if($conn){
        ...
        if(mysqli_num_rows($results)>=1){
            $signerror="email or mobile number already exist please try another email or mobile number";
                ...
                $query="INSERT INTO `accounts` (`fname`, `lname`, `email`, `password`, `date`, `month`, `year`, `gender`, `follower`) VALUES ('$fname', '$lname', '$mobile', '$password', '$day', '$month', '$year', '$gender', '0')";
...
<body>
    ...
    <div class="container">
      ...
      ?>
        ...
        <div class="AddUser"><div class="signup-pop">
        <div class="signup-form-container">
            ...
            <form id="inputform" class="signup-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"
                method="post">
                <div class="fullname">
                    <input class="input-signup signup-text" type="text" value="<?php echo $fname; ?>" name="fname" id="firstname"
                        placeholder="First name" required>
                    <input class="input-signup signup-text" type="text" name="lname" value="<?php echo $lname; ?>" id="lastname"
